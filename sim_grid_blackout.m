...
sim_params.blind_start = floor(20 / dt);
sim_params.blind_end = floor(35 / dt);
sim_params.blind_node = 16; 

baseline_params = sim_params;
...
fw_blind = Framework_Leader_Blackout(sim_params); fw_blind.run();
